...
public class SoapServiceTest {
    ...
    public static void checkBalance() {
        ...
        LOG.info("SOAP: Successful operation 'Check Balance'");
    }
    ...
    public void refillAccountNegative() {
        ...
        LOG.info("SOAP: Error. You have exceeded the possible limit");
    }
    ...
    public void refillAccountPositive() {
        ...
        LOG.info(String.format("SOAP: Account was refilled successfully by %.2f", TRANSFER_AMOUNT_PUT));
    }
    ...
    public void withdrawMoneyPositive() {
        ...
        LOG.info(String.format("SOAP: Perfectly. The money are withdrawn from your account - %.2f", TRANSFER_AMOUNT_GET));
    }
    ...
    public void withdrawMoneyNegative() {
        ...
        LOG.info("SOAP: An error occurred. The amount on your account is insufficient for transfer");
    }
}